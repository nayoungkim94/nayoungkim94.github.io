...
**Automated Evaluation of Machine-generated Summaries with RLHF** &mdash; *2024*\
Trained an LLM-based classifier to score document–summary pairs via multi-class classification and RLHF with a handcrafted human-preferences dataset; validated with expert evaluation.\
